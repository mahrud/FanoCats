...
layout: page
title: Bl2PPn
headline: '$\mathrm{Bl}_2\PP^n$: the blow-up of $\PP^n$ at 2 points'
---
...
{% include table.toric.html class='Bl2PPn' row_limit=1 varieties=site.data.Bl2PPn %}

**Tip:** use <kbd>j</kbd> and <kbd>l</kbd> to go back and forth and compare the data.
